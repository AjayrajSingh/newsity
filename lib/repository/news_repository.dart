...
import 'package:newsity/constants/newsApi_constants.dart';
import 'dart:convert';
...
class NewsRepository {
  ...
  Future<List<NewsModel>> searchNews({required String query}) async {
    ...
    if (query.isEmpty) {
      url =
          'https://newsapi.org/v2/everything?q=biden&from=2023-02-23&sortBy=popularity&apiKey=c3c8e3a211ed419c8da525aedac6625f';
    } else {
      url =
          "https://newsapi.org/v2/everything?q=$query&from=2023-02-23&sortBy=popularity&apiKey=${NewsApiConstants.newsApiKey}";
    }
